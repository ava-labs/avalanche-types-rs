...
///
/// On receiving the "pull" query, the engine issues the container and
/// all of its parents to the consensus, and sends chits for its voting.
#[derive(
    std::clone::Clone,
    std::cmp::Eq,
    std::cmp::Ord,
