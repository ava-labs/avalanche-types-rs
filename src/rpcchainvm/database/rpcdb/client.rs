...
use crate::rpcchainvm::database::{errors, DatabaseError};
use avalanche_proto::{
...
impl DatabaseClient {
    pub fn new(
        client_conn: Channel,
    ) -> Box<dyn crate::rpcchainvm::database::Database + Send + Sync> {
...
impl crate::rpcchainvm::database::Database for DatabaseClient {}

#[tonic::async_trait]
impl crate::rpcchainvm::database::KeyValueReaderWriterDeleter for DatabaseClient {
...
#[tonic::async_trait]
impl crate::rpcchainvm::database::Closer for DatabaseClient {
...
#[tonic::async_trait]
impl crate::rpcchainvm::health::Checkable for DatabaseClient {
