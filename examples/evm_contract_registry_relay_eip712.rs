...
/// cargo run --example evm_contract_registry_relay_eip712 --features="jsonrpc_client evm" -- [HTTP RPC ENDPOINT]
/// cargo run --example evm_contract_registry_relay_eip712 --features="jsonrpc_client evm" -- http://localhost:9876/rpc
#[tokio::main]
