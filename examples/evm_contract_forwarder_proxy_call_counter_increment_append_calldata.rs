...
use ethers_core::{
    abi::{encode as abi_encode, Function, Param, ParamType, StateMutability, Token},
    types::{H160, U256},
};

/// cargo run --example evm_contract_forwarder_proxy_call_counter_increment_append_calldata --features="jsonrpc_client evm" -- [HTTP RPC ENDPOINT] [PRIVATE KEY] [FORWARDER CONTRACT ADDRESS] [RECIPIENT CONTRACT ADDRESS]
/// cargo run --example evm_contract_forwarder_proxy_call_counter_increment_append_calldata --features="jsonrpc_client evm" -- http://127.0.0.1:9650/ext/bc/C/rpc 56289e99c94b6912bfc12adc093c9b51124f0dc54ac7a766b2bc5ccf558d8027 0x7Dabc90e633F60244B48541F6cDfD7100aB8a165 0x41a24Bc2AE2eFF7CA3a2562374F339eAd168a5dB
///
...
async fn main() -> io::Result<()> {
    ...
    let proxy_call_calldata = abi::encode_calldata(func, &arg_tokens).unwrap();
    log::info!(
        "proxy_call calldata: 0x{}",
        hex::encode(proxy_call_calldata.clone())
    );
    ...
    let mut appended_calldata = proxy_call_calldata.clone();
