...
#
# e.g.,
# cargo install protoc-gen-prost --version 0.2.0
...
#
# e.g.,
# cargo install protoc-gen-tonic --version 0.2.0
...
#
# e.g.,
# cargo install protoc-gen-prost-crate --version 0.3.0
...
echo "Pulling proto source for protcol version: ${PROTOCOL_VERSION}..."
